...
**
** Created: Sat Nov 26 18:09:57 2011
...
static const char qt_meta_stringdata_Viewer[] = {
    "Viewer\0\0index\0itemClicked(QModelIndex)\0"
};

const QMetaObject Viewer::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_Viewer,
...
int Viewer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: itemClicked((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
